...
function compareCharCodeAtAndCodePointAt(string, index) {
  ...
  let charAtResult = string.charCodeAt(string);
  let atResult = string.at(string);
  let charCodeAtResult = string.charCodeAt(string);
  let codePointAtResult = string.codePointAt(string); 
  return `charCodeAt:${charCodeAtResult}, codePointAt:${codePointAtResult}, charAt:${atResult}, at: ${atResult}`;
}
